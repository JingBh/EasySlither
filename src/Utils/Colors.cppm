...
export const auto BLACK = easyx::fromRGB(0, 0, 0);
...
export const auto ZINC_700 = easyx::fromRGB(63, 63, 70);
...
export const auto TEAL_700 = easyx::fromRGB(15, 118, 110);

export const auto CYAN_300 = easyx::fromRGB(103, 232, 249);
export const auto CYAN_700 = easyx::fromRGB(14, 116, 144);
